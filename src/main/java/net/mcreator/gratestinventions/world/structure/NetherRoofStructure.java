...
public class NetherRoofStructure extends GratestInventionsModElements.ModElement {
	...
	public NetherRoofStructure(GratestInventionsModElements instance) {
		super(instance, 33);
	...
	public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
		event.getRegistry().register(feature.setRegistryName("nether_roof"));
	}
