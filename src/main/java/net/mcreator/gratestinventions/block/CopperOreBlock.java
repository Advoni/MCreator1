...
public class CopperOreBlock extends GratestInventionsModElements.ModElement {
	@ObjectHolder("gratest_inventions:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(GratestInventionsModElements instance) {
		super(instance, 76);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 5)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(10, 45, 45, 85))));
		}
	}
}
