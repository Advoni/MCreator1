...
public class SilverOreBlock extends GratestInventionsModElements.ModElement {
	@ObjectHolder("gratest_inventions:silver_ore")
	public static final Block block = null;
	public SilverOreBlock(GratestInventionsModElements instance) {
		super(instance, 78);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 6)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(4, 3, 3, 36))));
		}
	}
}
