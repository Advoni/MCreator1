...
public class LeadOreBlock extends GratestInventionsModElements.ModElement {
	@ObjectHolder("gratest_inventions:lead_ore")
	public static final Block block = null;
	public LeadOreBlock(GratestInventionsModElements instance) {
		super(instance, 82);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 7)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(8, 1, 1, 28))));
		}
	}
}
