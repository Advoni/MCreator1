...
public class MilkBlock extends GratestInventionsModElements.ModElement {
	@ObjectHolder("gratest_inventions:milk")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("gratest_inventions:milk_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public MilkBlock(GratestInventionsModElements instance) {
		super(instance, 61);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing, FluidAttributes
				.builder(new ResourceLocation("gratest_inventions:blocks/milk_still"), new ResourceLocation("gratest_inventions:blocks/milk_flow"))
