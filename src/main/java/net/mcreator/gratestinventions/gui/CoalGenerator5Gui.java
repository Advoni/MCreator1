...
public class CoalGenerator5Gui extends GratestInventionsModElements.ModElement {
	...
	public CoalGenerator5Gui(GratestInventionsModElements instance) {
		super(instance, 115);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("coal_generator_5"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("gratest_inventions:textures/coal_generator_5.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			...
			}.getValue(new BlockPos((int) x, (int) y, (int) z), "Energy")) + "", 132, 6, -39424);
			this.font.drawString("" + (new Object() {
				public double getValue(BlockPos pos, String tag) {
					TileEntity tileEntity = world.getTileEntity(pos);
					if (tileEntity != null)
			...
			}.getValue(new BlockPos((int) x, (int) y, (int) z), "fuel")) + "", 78, 65, -11776948);
			this.font.drawString("Coal Generator", 6, 6, -11776948);
			this.font.drawString("Gen.: 1IE/T", 6, 29, -11776948);
			this.font.drawString("Out: 10IE/T", 6, 38, -11776948);
		}
