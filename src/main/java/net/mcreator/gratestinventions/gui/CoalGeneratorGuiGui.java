...
public class CoalGeneratorGuiGui extends GratestInventionsModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public CoalGeneratorGuiGui(GratestInventionsModElements instance) {
		super(instance, 69);
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("gratest_inventions:textures/coal_generator_gui.png");
		@Override
