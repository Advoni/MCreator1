...
public class ZweiTestGui extends GratestInventionsModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public ZweiTestGui(GratestInventionsModElements instance) {
		super(instance, 71);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("zwei_test"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("gratest_inventions:textures/zwei_test.png");
		@Override
