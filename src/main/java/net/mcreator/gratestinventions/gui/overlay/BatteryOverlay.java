...
import net.mcreator.gratestinventions.procedures.BatteryDisplayOverlayIngameProcedure;
...
public class BatteryOverlay extends GratestInventionsModElements.ModElement {
	public BatteryOverlay(GratestInventionsModElements instance) {
		super(instance, 68);
	}
