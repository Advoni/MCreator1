...
public class IronGearItem extends GratestInventionsModElements.ModElement {
	@ObjectHolder("gratest_inventions:iron_gear")
	public static final Item block = null;
	public IronGearItem(GratestInventionsModElements instance) {
		super(instance, 53);
	}
