...
public class GoldGearItem extends GratestInventionsModElements.ModElement {
	@ObjectHolder("gratest_inventions:gold_gear")
	public static final Item block = null;
	public GoldGearItem(GratestInventionsModElements instance) {
		super(instance, 52);
	}
