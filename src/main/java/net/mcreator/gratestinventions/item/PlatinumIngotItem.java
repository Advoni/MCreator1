...
public class PlatinumIngotItem extends GratestInventionsModElements.ModElement {
	@ObjectHolder("gratest_inventions:platinum_ingot")
	public static final Item block = null;
	public PlatinumIngotItem(GratestInventionsModElements instance) {
		super(instance, 63);
	}
