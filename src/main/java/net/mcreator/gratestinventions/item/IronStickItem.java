...
public class IronStickItem extends GratestInventionsModElements.ModElement {
	@ObjectHolder("gratest_inventions:iron_stick")
	public static final Item block = null;
	public IronStickItem(GratestInventionsModElements instance) {
		super(instance, 48);
	}
