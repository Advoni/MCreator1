...
public class SilverIngotItem extends GratestInventionsModElements.ModElement {
	@ObjectHolder("gratest_inventions:silver_ingot")
	public static final Item block = null;
	public SilverIngotItem(GratestInventionsModElements instance) {
		super(instance, 64);
	}
